...
function spreadCommentList(result){
	...
	for(let i=0;i<result.length;i++){
		...
		html+=`<button type="button" data-cno="${result[i].cno}"class="btn btn-sm btn-outline-waring cmtModBtn">%</button>`;
		html+=`<button type="button" data-cno="${result[i].cno}"class="btn btn-sm btn-outline-waring cmtDelBtn">X</button>`;
